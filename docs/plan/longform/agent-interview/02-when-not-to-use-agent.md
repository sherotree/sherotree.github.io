...
> 系列：[第 1 题](./01-what-is-agent.md) · [第 0 题 · 地图](./00-series-map.md) · 下一题：第 3 题｜ReAct 与 Plan-and-Execute
...
- 上一题：[第 1 题｜边界](./01-what-is-agent.md)  
- 下一题：[第 3 题｜ReAct 与 Plan-and-Execute](./03-react-vs-plan-execute.md)  
- 地图：[第 0 题](./00-series-map.md)

---

**标签建议**：`Agent` `面试` `架构决策` `Workflow`
